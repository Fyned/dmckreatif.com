...
export default function NeoButton({
  ...
  const baseClasses = `inline-flex items-center justify-center gap-2 font-space transition-all duration-150 ${sizeClasses[size]} ${variantClasses[variant]} ${disabled ? "opacity-50 pointer-events-none" : ""} ${className}`;
