          ...
          <div className="flex items-center gap-3 flex-shrink-0">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-neo-lime/70">
                {t("promo.saveUpTo", "Introductory rates for new clients")}
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <h3 className="font-space font-bold text-xl lg:text-2xl text-neo-lime mb-2">
            {t("promo.title", "INTRODUCTORY PRICING — PREMIUM QUALITY")}
          </h3>
          <p className="font-mono text-sm text-neo-lime/80 leading-relaxed max-w-xl">
            {t(
              "promo.description",
              "We are expanding across Europe. Get premium web development at introductory rates — the same quality, accessible pricing."
            )}
          </p>
        </div>
