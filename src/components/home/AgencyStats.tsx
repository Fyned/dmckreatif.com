...
const stats = [
  { key: "projects", value: 10, suffix: "+", prefix: "", color: "bg-neo-lime" },
  { key: "countries", value: 4, suffix: "", prefix: "", color: "bg-neo-yellow" },
  { key: "lighthouse", value: 95, suffix: "+", prefix: "", color: "bg-neo-blue" },
  { key: "loadTime", value: 2, suffix: "s", prefix: "<", color: "bg-neo-green" },
] as const;
