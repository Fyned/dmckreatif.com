        ...
        >
          {services.map(({ key, Icon, color, num }, i) => (
            ...
            >
              ...
              <h3 className="font-space font-bold text-xl mb-3 text-neo-black group-hover:text-neo-black transition-colors">
                {t(`${key}.title`)}
              </h3>
              <p className="font-mono text-sm text-neo-black leading-relaxed mb-6 group-hover:text-neo-black transition-colors">
                {t(`${key}.description`)}
              </p>
              <span className="font-space font-bold text-lg text-neo-black group-hover:text-neo-black transition-colors">
                {t(`${key}.priceRange`)}
              </span>
            </motion.div>
          ))}
